...
export default (props) => {
  ...
  return (
      <nav className="w-full border-b md:border-0 md:static md:flex md:justify-center relative z-50">
          <div className="items-center px-4 bg-white mx-auto md:flex md:px-8 fixed top-0 w-full md:items-center">
            <div className="items-center px-4 max-w-screen-xl mx-auto md:flex md:px-8 w-full">
              ...
              <div className="hidden md:inline-block">
                <a href="tel:9807060455" className="py-3 px-4 text-white bg-indigo-600 hover:bg-indigo-700 rounded-md shadow">
                    Call Now
                </a>
              </div>
              </div>
